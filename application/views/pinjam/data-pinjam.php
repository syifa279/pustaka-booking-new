					...
					<div class="table-responsive full-width">
						...
						<table class="table table-bordered table-striped table-hover" id="table-datatable">
						 ...
						 <tr> 
						 	...
						 	<th>Terlambat</th> <th>Denda</th> 

						 	<th>Status</th> <th>Total Denda</th> 
						 		...
						 		{ 
						 			...
						 			<tr> 
						 				...
						 				<td> 
						 					...
						 					$tgl2 = new DateTime(); $selisih = $tgl2->diff($tgl1)->format("%a"); 
						 			...
						 			<td nowrap> 
						 				...
						 				<?php if ($p['status'] == "Kembali") { ?> <i class="btn btn-sm btn-outline-secondary"><i class="fas fa-fw fa-edit"></i>Ubah Status</i> 
